...
<head>
    ...
    <title>ParkingSure — Recuperar Contraseña</title>
...
<body>
    <div class="auth-shell">
        ...
        <div class="auth-body">
            ...
            <p class="subtitle">Ingresa tu correo electrónico y te enviaremos un enlace para restablecer tu contraseña de acceso.</p>
